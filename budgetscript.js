...
form.addEventListener("submit", async (e) => {
  ...
  resultDiv.innerHTML = "🔄 Generating your AI plan...";

  // 👉 UPDATED URL: Points to the Flask server running on port 5000
  ...
  try {
    ...
    resultDiv.innerHTML = `<strong>💡 Your AI Budget Plan:</strong><br><br>${data.plan}`;
  } catch (error) {
    console.error(error);
    resultDiv.innerHTML =
      `❌ Could not connect to the AI server. Details: ${error.message}.`;
  }
});